...
<div></div>\
<textarea rows=6 cols=60 style="margin:15px 0 15px;font-family:monospace;white-space:pre;overflow-wrap:normal;overflow-x:scroll;resize:vertical"></textarea>\
<div></div>\
